...
public class IDExporter {
    ...
    public void addItem(String n, String sentence) {
       ...
       // outputChain += "<cs:><cf:><ct:Bold><cs:10.000000><cf:Rotis Serif Std>" + n + ".<ct:><cs:><cf:><cs:10.000000><cf:Rotis Serif Std>" + word + "\r\n";
    ...
    public  void addTitle(String titulo) {
        ...
        //outputChain += "<cs:><cf:><pstyle:NormalParagraphStyle><ct:Bold><cs:13.000000><cf:Rotis Serif Std>" + titulo + "\r\n";
